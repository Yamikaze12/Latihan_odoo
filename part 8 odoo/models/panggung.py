...
class Panggung(models.Model):
    _name = 'weddingorg.panggung'
    _description = 'Jenis Panggung'

    name = fields.Char(string='Name',required=True)
    pelaminan_id = fields.Many2one(comodel_name='weddingorg.pelaminan', 
                                string='Type Pelaminan',
                                required=True
                                )
    kursipengantin_id = fields.Many2one(comodel_name='weddingorg.kursipengantin', 
